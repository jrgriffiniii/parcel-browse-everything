...
- Submit a [Github issue](https://github.com/samvera/parcel-browse-everything/issues/) by:
...
2. RuboCop/parcel-browse-everything - where we check for style violations
